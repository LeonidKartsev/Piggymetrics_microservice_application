...
{{ include "piggymetrics.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "piggymetrics.selectorLabels" -}}
...
*/}}
{{- define "piggymetrics.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "piggymetrics.fullname" .) .Values.serviceAccount.name }}
{{- else }}
